...
void ABattleHttpActor::HttpPost(FEnvironmentState environmentState, FBattleTurnState battleTurnState, ABaseBattlePawn* unit)
{
	...
	{
		// 요청 URL - 서버가 알려줌
		httpRequest->SetURL(TEXT("https://718f-221-148-189-129.ngrok-free.app/service1/battle/start"));
	...
	{
		// 요청 URL - 서버가 알려줌
		httpRequest->SetURL(TEXT("https://718f-221-148-189-129.ngrok-free.app/service1/battle/action"));
	}
	// 요청 방식
